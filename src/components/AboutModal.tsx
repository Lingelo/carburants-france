      ...
      >
        ...
        <div className="mt-4 rounded-lg bg-gray-50 px-3 py-2.5">
          ...
          <ul className="space-y-1 text-xs text-gray-500">
            <li>
              <a href="https://donnees.roulez-eco.fr/opendata/instantane" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">prix-carburants.gouv.fr</a>
              {' '}— Prix des carburants en temps réel
            </li>
            <li>
              <a href="https://data.ademe.fr/datasets/ademe-car-labelling" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">ADEME Car Labelling</a>
              {' '}— Consommation des véhicules neufs
            </li>
            <li>
              <a href="https://www.eea.europa.eu/en/datahub/datahubitem-view/fa8b1229-3db6-495d-b18e-9c9b3267c02b" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">EEA CO2 Monitoring</a>
