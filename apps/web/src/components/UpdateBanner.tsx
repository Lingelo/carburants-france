...
export function UpdateBanner() {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 left-1/2 -translate-x-1/2 z-[1100] bg-surface-container-lowest border border-outline-variant rounded-full shadow-[0_4px_24px_rgba(0,0,0,0.18)] px-4 py-2 flex items-center gap-2 animate-[slideUp_280ms_ease-out]">
